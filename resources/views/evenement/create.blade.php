...
<x-app-layout>
    ...
    <form method="POST" enctype="multipart/form-data" action="{{ route('Evenement.store') }}" class="max-w-md mx-auto">
        @csrf
        ...
        <div class="relative z-0 w-full mb-5 group">
            <select name="type_of_reservation" id="type_of_reservation"
                ...
                <option value="par_confirmation">By confirmation</option>
            </select>
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input type="file" name="image" id="image" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" required />
